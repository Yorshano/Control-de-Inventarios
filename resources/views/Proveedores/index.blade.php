...
<head>
    ...
    <title>El Ché | @yield('titulo', 'Proveedores')</title>
    <!-- Favicon-->
    ...
    <header class="masthead bg-secondary text-white text-center" style="padding: 2rem 0;">
        <div class="container d-flex align-items-center flex-column">
            ...
            <h1 class="masthead-heading text-uppercase mb-0" style="font-size: 2rem; margin-bottom: 1rem;">
                @yield('titulo', 'Lista de Proveedores')</h1>
            <!-- Icon Divider-->
        </div>
    </header>
                ...
                <tbody>
                    @foreach ($proveedores as $proveedore)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('proveedores.edit', $proveedore->id) }}" class="btn btn-primary">Editar</a>
