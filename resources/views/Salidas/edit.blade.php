...
<head>
    ...
    <title>El Ché | @yield('titulo', 'Editar Salida')</title>
    <!-- Favicon-->
        ...
        <div class="container">
            ...
            <form action="{{ route('salidas.update', $salida->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="cantidad" name="cantidad" value="{{ $salida->cantidad }}" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="descripcion" name="descripcion">{{ $salida->descripcion }}</textarea>
                </div>
