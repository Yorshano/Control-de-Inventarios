...
<head>
    ...
    <title>El Ché | @yield('titulo', 'Añadir Caracterización')</title>
    <!-- Favicon-->
    ...
    <header class="masthead bg-secondary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <h1 class="masthead-heading text-uppercase mb-0" style="font-size: 2rem; margin-bottom: 1rem;">
                @yield('titulo', 'Añadir Caracterización')</h1>
            <!-- Icon Divider-->
        </div>
    </header>
    ...
    <div class="content">
        <div class="container">
            <div class="page-section portfolio">
                <h2>Añadir Nueva Caracterización</h2>
                <form action="{{ route('caracterizacions.store') }}" method="POST">
                    @csrf
