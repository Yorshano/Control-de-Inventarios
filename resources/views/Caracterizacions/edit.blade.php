...
<head>
    ...
    <title>El Ché | @yield('titulo', 'Editar Caracterizacion')</title>
    <!-- Favicon-->
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-8">
                    ...
                    <h1 class="masthead-heading text-uppercase mb-0" style="font-size: 2rem; margin-bottom: 1rem;">
                        @yield('titulo', 'Editar Caracterizacion')
                    </h1>
                </div>
                <div class="col-md-2">
    ...
    <div class="content">
        <div class="container">
            <div class="page-section portfolio">
                <h2>Editar Caracterizacion</h2>
                <form action="{{ route('caracterizacions.update', $caracterizacion->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                        <label for="nombre">Nombre</label>
                        <input type="text" class="form-control" id="nombre" name="nombre"
                            value="{{ $caracterizacion->nombre }}" required>
                    </div>
                    <div class="form-group">
                        <label for="descripcion">Descripción</label>
                        <textarea class="form-control" id="descripcion" name="descripcion">{{ $caracterizacion->descripcion }}</textarea>
                    </div>
