...
<head>
    ...
    <title>El Ché | @yield('titulo', 'Editar Tipo')</title>
    <!-- Favicon-->
            ...
            <div class="page-section portfolio">
                ...
                <form action="{{ route('tipos.update', $tipo->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="descripcion" name="descripcion">{{ $tipo->descripcion }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="caracterizacion_id">Caracterización</label>
                        <select class="form-control" id="caracterizacion_id" name="caracterizacion_id" required>
                            @foreach ($caracterizaciones as $caracterizacion)
                                <option value="{{ $caracterizacion->id }}"
                                    {{ $tipo->caracterizacion_id == $caracterizacion->id ? 'selected' : '' }}>
