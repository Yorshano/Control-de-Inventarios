...
<head>
    ...
    <title>El Ché | @yield('titulo', 'Editar Entrada')</title>
    <!-- Favicon-->
        ...
        <div class="container">
            ...
            <form action="{{ route('entradas.update', $entrada->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="cantidad" name="cantidad" value="{{ $entrada->cantidad }}" required>
                </div>
    
                <div class="form-group">
                    <label for="fecha">Fecha</label>
                    <input type="date" class="form-control" id="fecha" name="fecha" value="{{ $entrada->fecha }}" required>
                </div>
